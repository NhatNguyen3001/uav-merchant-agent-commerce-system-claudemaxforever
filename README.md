...
| `MACS_MODEL` | Claude model for all three roles | `claude-opus-5` |
...
A full live run takes about 30 seconds on Claude Opus 5. The two proposal compositions dominate; intent decoding takes about 4 seconds and each buyer reply about 3. Two decisions came from measurement:
